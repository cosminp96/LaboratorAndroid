...
public class MySensorAdapter extends ArrayAdapter<Sensor> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if(convertView == null){
            ...
            viewHolder.itemView = (TextView) convertView.findViewById(R.id.rowTextView);
        ...
        if(item!=null) viewHolder.itemView.setText("Name: " + item.getName()
                + " / Int Type: " + item.getType()
                + " / String Type: " + sensorTypeToString(item.getType())
                + " / Vendor: " + item.getVendor()
                + " / Version: " + item.getVersion()
                + " / Resolution: " + item.getResolution()
                + " / Power: " + item.getPower()
                + " mAh / Maximum Range: " + item.getMaximumRange());
